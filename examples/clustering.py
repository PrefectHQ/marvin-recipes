...
class KnowledgeGraph:
    ...
    async def update_graph_with_chroma(
        ...
        async with self.chroma(client_type="base") as chroma:
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        bot = AIApplication(description="A chatbot")
        ...
        for content in [
            ...
            bot.history.add_message(Message(content=content, role="user"))

        messages = bot.history.get_messages()
